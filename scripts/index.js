...
const modalDescriptionInput = modalEdit.querySelector("#profile-description-input"
);
...
const previewModalClose = previewModal.querySelector( ".modal__close-btn_type_preview"
);
